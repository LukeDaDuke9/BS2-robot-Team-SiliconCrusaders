...
// ===========================
const char *ssid = "SusyLaptopHostingSketchyNetwork";
const char *username = "naegle.luke";
const char *password = "apalationtrail";
...
visit rtsp://ip:554 for the real time stream
